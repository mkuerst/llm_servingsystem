...
"""Logging configuration for my_project."""
import logging
import sys
import os
...
_LOG_LEVEL = os.environ.get("my_project_LOG_LEVEL", "debug")
_LOG_LEVEL = getattr(logging, _LOG_LEVEL.upper(), 0)
_LOG_DIR = os.environ.get("my_project_LOG_DIR", None)
...
_root_logger = logging.getLogger("my_project")
