...
from my_project.models.llama.layer_infer.transformer_layer_infer import LlamaTransformerLayerInfer
...
from my_project.models.llama.layer_weights.ds_load_utils import load_ds_weights
...
from my_project.common.basemodel import TpPartBaseModel
from my_project.common.mem_utils import select_mem_manager_class
...
class LlamaTpPartModel(TpPartBaseModel):
    ...
    def _init_to_get_rotary(self, default_base=10000):
        ...
        # NTK
        try:
            ntk_alpha = float(os.environ.get("my_project_NTK_ALPHA", 1))
            assert ntk_alpha >= 1
            if ntk_alpha > 1:
