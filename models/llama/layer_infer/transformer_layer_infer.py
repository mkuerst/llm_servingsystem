...
from my_project.models.llama.layer_weights.transformer_layer_weight import LlamaTransformerLayerWeight
from my_project.models.llama.triton_kernel.context_flashattention_nopad import (
    context_flashattention_fwd,
    context_flashattention_fwd_no_prompt_cache,
)
from my_project.models.llama.triton_kernel.context_attention_nopad import (
    context_attention_fwd,
    context_attention_fwd_no_prompt_cache,
)
from my_project.models.llama.triton_kernel.token_attention_nopad_att1 import token_att_fwd, token_att_fwd_int8k
from my_project.models.llama.triton_kernel.token_attention_nopad_softmax import token_softmax_fwd
from my_project.models.llama.triton_kernel.token_attention_nopad_reduceV import token_att_fwd2, token_att_fwd2_int8v
from my_project.models.llama.triton_kernel.rmsnorm import rmsnorm_forward
from my_project.models.llama.triton_kernel.rotary_emb import rotary_emb_fwd
from my_project.models.llama.triton_kernel.silu_and_mul import silu_and_mul_fwd

from my_project.models.llama.infer_struct import LlamaInferStateInfo
from my_project.models.llama.splitfuse_infer_struct import SplitFuseInferStateInfo
from my_project.common.basemodel.triton_kernel.destindex_copy_kv import destindex_copy_kv, destindex_copy_quantize_kv
from my_project.common.basemodel import TransformerLayerInferTpl
from my_project.models.llama.triton_kernel.splitfuse_context_flashattention_nopad import (
...
class LlamaTransformerLayerInfer(TransformerLayerInferTpl):
    ...
    def __init__(self, layer_num, tp_rank, world_size, network_config, mode=[], flash_attention=True):
    ...
    def _bind_attention(self):
        if self.flash_attention:
            self._context_attention_kernel = partial(LlamaTransformerLayerInfer._context_flashattention_kernel, self)
        else:
    ...
    def _context_flashattention_kernel(
        self, q, kv, infer_state: LlamaInferStateInfo, layer_weight, out=None
    ) -> torch.Tensor:
        o_tensor = torch.empty_like(q) if out is None else out
        if infer_state.use_dynamic_prompt_cache:
    ...
    def _copy_kv_to_mem_cache_ppl_int8kv(self, buffer, mem_index, mem_manager):
        from my_project.models.llama.triton_kernel.ppl_quant_copy_kv import destindex_copy_quantize_kv
    ...
    def _copy_kv_to_mem_cache_ppl_int4kv(self, buffer, mem_index, mem_manager):
        from my_project.models.llama.triton_kernel.ppl_int4kv_copy_kv import destindex_copy_int4kv
    ...
    def _token_decode_attention_normal(self, q, infer_state: LlamaInferStateInfo, layer_weight, out=None):
        ...
        att_m_tensor = torch.empty((self.tp_q_head_num_, total_token_num), dtype=torch.float32, device="cuda")
        ...
        o_tensor = torch.empty_like(q) if out is None else out
        from my_project.models.llama.triton_kernel.token_attention_softmax_and_reducev import (
    ...
    def _token_decode_attention_flashdecoding(self, q, infer_state: LlamaInferStateInfo, layer_weight, out=None):
        from my_project.models.llama.triton_kernel.flash_decoding import token_decode_attention_flash_decoding
    ...
    def _token_decode_attention_ppl_int8kv(self, q, infer_state: LlamaInferStateInfo, layer_weight, out=None):
        ...
        from my_project_ppl_kernel import group8_int8kv_decode_attention
    ...
    def _token_decode_attention_ppl_fp16(self, q, infer_state: LlamaInferStateInfo, layer_weight, out=None):
        ...
        calcu_shape1 = (batch_size, self.tp_q_head_num_, self.head_dim_)
        o_tensor = torch.empty_like(q) if out is None else out
        from my_project_ppl_fp16_kernel import fp16_decode_attention
    ...
    def _token_decode_attention_ppl_fp16_flashdecoding(
        ...
        from my_project.models.llama.triton_kernel.ppl_fp16_flash_decoding import token_decode_attention_flash_decoding
    ...
    def _token_decode_attention_ppl_int8kv_flashdecoding(
        ...
        from my_project.models.llama.triton_kernel.ppl_int8kv_flash_decoding import token_decode_attention_flash_decoding
    ...
    def _token_decode_attention_ppl_int4kv_flashdecoding(
        ...
        from my_project.models.llama.triton_kernel.ppl_int4kv_flash_decoding import token_decode_attention_flash_decoding
