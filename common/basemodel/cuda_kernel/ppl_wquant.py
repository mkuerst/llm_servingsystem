...
def quantize_int4_ppl(weight, group_size=128, tp_rank=8):
    ...
    from my_project_ppl_int4_kernel import int4_weight_encode
...
def matmul_dequantize_int4_ppl(
    ...
    from my_project_ppl_int4_kernel import matmul_i4_fp16
    from my_project_ppl_int4_kernel import int4_weight_decode
    BATCHSIZE = x.shape[0]
    if BATCHSIZE >= 768:
